...
static const AVOption options[] = {
    ...
    { "tune",        "Set the encoding tuning info",        OFFSET(tuning_info),  AV_OPT_TYPE_INT,   { .i64 = HJK_ENC_TUNING_INFO_HIGH_QUALITY }, HJK_ENC_TUNING_INFO_HIGH_QUALITY, HJK_ENC_TUNING_INFO_LOSSLESS,  VE, "tune" },
    { "hq",          "High quality",                        0,                    AV_OPT_TYPE_CONST, { .i64 = HJK_ENC_TUNING_INFO_HIGH_QUALITY },             0, 0, VE, "tune" },
    { "ll",          "Low latency",                         0,                    AV_OPT_TYPE_CONST, { .i64 = HJK_ENC_TUNING_INFO_LOW_LATENCY },              0, 0, VE, "tune" },
    { "ull",         "Ultra low latency",                   0,                    AV_OPT_TYPE_CONST, { .i64 = HJK_ENC_TUNING_INFO_ULTRA_LOW_LATENCY },        0, 0, VE, "tune" },
    { "lossless",    "Lossless",                            0,                    AV_OPT_TYPE_CONST, { .i64 = HJK_ENC_TUNING_INFO_LOSSLESS },                 0, 0, VE, "tune" },
#endif
...
#ifdef ABCD
#ifdef HJKENC_HAVE_MJPEG_LVL6
    { "level",        "Set the encoding level restriction", OFFSET(level),        AV_OPT_TYPE_INT,   { .i64 = HJK_ENC_LEVEL_AUTOSELECT }, HJK_ENC_LEVEL_AUTOSELECT, HJK_ENC_LEVEL_MJPEG_62, VE, "level" },
#else
    { "level",        "Set the encoding level restriction", OFFSET(level),        AV_OPT_TYPE_INT,   { .i64 = HJK_ENC_LEVEL_AUTOSELECT }, HJK_ENC_LEVEL_AUTOSELECT, HJK_ENC_LEVEL_MJPEG_52, VE, "level" },
#endif
    ...
    { "5.2",          "",                                   0,                    AV_OPT_TYPE_CONST, { .i64 = HJK_ENC_LEVEL_MJPEG_52 },       0, 0, VE, "level" },
#ifdef HJKENC_HAVE_MJPEG_LVL6
    { "6.0",          "",                                   0,                    AV_OPT_TYPE_CONST, { .i64 = HJK_ENC_LEVEL_MJPEG_60 },       0, 0, VE, "level" },
    { "6.1",          "",                                   0,                    AV_OPT_TYPE_CONST, { .i64 = HJK_ENC_LEVEL_MJPEG_61 },       0, 0, VE, "level" },
    { "6.2",          "",                                   0,                    AV_OPT_TYPE_CONST, { .i64 = HJK_ENC_LEVEL_MJPEG_62 },       0, 0, VE, "level" },
#endif
    ...
    { "cbr_ld_hq",    "Constant bitrate low delay high quality mode", 0,          AV_OPT_TYPE_CONST, { .i64 = RCD(HJK_ENC_PARAMS_RC_CBR_LOWDELAY_HQ) },      0, 0, VE, "rc" },
    { "cbr_hq",       "Constant bitrate high quality mode", 0,                    AV_OPT_TYPE_CONST, { .i64 = RCD(HJK_ENC_PARAMS_RC_CBR_HQ) },               0, 0, VE, "rc" },
    { "vbr_hq",       "Variable bitrate high quality mode", 0,                    AV_OPT_TYPE_CONST, { .i64 = RCD(HJK_ENC_PARAMS_RC_VBR_HQ) },               0, 0, VE, "rc" },
    ...
    { "multipass",    "Set the multipass encoding",         OFFSET(multipass),    AV_OPT_TYPE_INT,   { .i64 = HJK_ENC_MULTI_PASS_DISABLED },         HJK_ENC_MULTI_PASS_DISABLED, HJK_ENC_TWO_PASS_FULL_RESOLUTION, VE, "multipass" },
    { "disabled",     "Single Pass",                        0,                    AV_OPT_TYPE_CONST, { .i64 = HJK_ENC_MULTI_PASS_DISABLED },         0,                          0,                               VE, "multipass" },
    { "qres",         "Two Pass encoding is enabled where first Pass is quarter resolution",
                                                            0,                    AV_OPT_TYPE_CONST, { .i64 = HJK_ENC_TWO_PASS_QUARTER_RESOLUTION }, 0,                          0,                               VE, "multipass" },
    { "fullres",      "Two Pass encoding is enabled where first Pass is full resolution",
                                                            0,                    AV_OPT_TYPE_CONST, { .i64 = HJK_ENC_TWO_PASS_FULL_RESOLUTION },    0,                          0,                               VE, "multipass" },
#endif
...
AVCodec ff_hjkenc_encoder = {
    ...
    .wrapper_name   = "hjkenc",
    .hw_configs     = ff_hjkenc_hw_configs,
};
#endif
